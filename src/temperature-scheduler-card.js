...
import { VERSION, validateConfig, getStubConfig, DEFAULT_CONFIG } from './config.js';
...
export class TemperatureSchedulerCard extends LitElement {
  ...
  toggleMenu() {
    ...
    this.isMenuOpen = !this.isMenuOpen;
      ...
      handleLanguageSelect(lang) {
        ...
        console.log(`[LANG] handleLanguageSelect called with: ${lang}`);



        console.log(`[LANG] this.language before: ${this.language}`);
        ...
        console.log(`[LANG] this.language after: ${this.language}`);
        ...
        console.log('[LANG] Calling updateChartLabels');
  ...
  async initializeCard() {
    ...
    if (chartContainer) {
      ...
      chartContainer.focus(); // Automatically focus the chart
